...
//      Enter First Name
        driver.findElement(By.id("FirstName")).sendKeys("Tia");
//      Enter Last Name
...
//        Enter year in date of birth
        driver.findElement(By.xpath("/html/body/div[6]/div[3]/div/div/div/div[2]/form/div[1]/div[2]/div[4]/div/select[2]")).click();
//        Enter email id
        driver.findElement(By.id("Email")).sendKeys("Tia123@yahoo.com");
//        Enter company name
        driver.findElement(By.id("Company")).sendKeys("Singh & Company");
